...
function loadform(){
	...
	document.getElementById("mytablehscroll").onscroll = hscrollme;
}
...
function adjustform2(){
	...
	var tablecontainer = document.getElementById('tableContainer');
	var tablehview = tablecontainer.getElementsByClassName('tableHView')[0];
	...
	var headerheight = 0;
	var rows = tablehview.getElementsByClassName('tableHeader')[0].getElementsByClassName('tableRow');
	...
	var footerheight = 0;
	var rows = tablehview.getElementsByClassName('tableFooter')[0].getElementsByClassName('tableRow');
	...
	var contentheight = 0;
	var rows = tablehview.getElementsByClassName('tableContent')[0].getElementsByClassName('tableRow');
	for (i=0; i<rows.length; i++) {
	...
	if (contentspace > 0 ){
		...
		tablecontainer.style.width = window.innerWidth;
		/* tablehview.style.width = window.innerWidth; */
		tablehview.getElementsByClassName('tableVView')[0].style.height = contentspace;
		var vscroll = tablehview.getElementsByClassName('vscroll')[0];
...
function vscrollme(event){
	document.getElementById("vscrollme").style.top =  "-" + event.target.scrollTop + "px";
}

function hscrollme(event){
	document.getElementById("hscrollme").style.left =  "-" + event.target.scrollLeft + "px";
}
