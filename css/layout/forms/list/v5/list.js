...
function adjustcolwidths(){
	...
	adjustform();
/*	var voidwidth = window.innerWidth - voidleft - 16;
	var voidleft = left;
	var voidcols = document.getElementById('formtable').getElementsByClassName('voidCol');
	for (var icol = 0; icol < voidcols.length; icol++){
		voidcols[icol].style.left = voidleft;
		voidcols[icol].style.width = voidwidth;
	}
*/
}
